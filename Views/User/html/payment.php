            ...
            <div class="cart-detail">
              ...
              <div class="middle-cart-detail">
                  <div class="col-md-7 col-lg-7">
                    ...
                    <form class="form-horizontal" action="?mod=hoadon&act=themact" method="post">
                        <input type="hidden" name="Ma" value="<?php echo $khachhang['Ma'] ?>">
                        <input type="hidden" name="Tongtien" value="<?php echo $_SESSION['gia'] ?>">
                        <div class="form-group">
                          <label class="control-label col-sm-2" for="Ten">Name:</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="Ten" readonly="readonly" value="<?php  echo $khachhang['Tenkhach']?>">
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10"> 
                            <input type="text" class="form-control" name="Diachi" placeholder="Enter your address">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-sm-2" for="add">Phone</label>
                          <div class="col-sm-10"> 
                            <input type="phone" class="form-control" name="Sodienthoai" placeholder="Enter your Phone">
                          </div>
                        </div>
                    
                    <?php }else{?>
                      <h3 class="text-center">Please <a href="?mod=user&act=dangnhap">login</a> to proceed to payment</h3>
                    <?php }?>                    
                  </div>
                    ...
                    <div class="payment-detail">
                      ...
                      <div class="row">
                            ...
                            <div class="col-md-3 col-lg-3">
                              <b>$<?php echo $_SESSION['gia'] ?>.00</b>
                            </div>
                      </div>
                      <div class="btn-add">
                      <?php if(isset($khachhang)){ ?>
                        <button type="submit" id="checkoutBtn" class="btn btn-danger">Pay</button>
                      <?php } ?>
                     </form> 
