  ...
  <div class="container content">
    <div class="row">
      ...
      <div class="col-xs-12 category-page">
          ...
          <div style="clear: both;"></div>
            <div class="cart-detail" style="min-height: 300px; text-align: center;">
              ...
              <h2 class="text-center">Complete, Plese check your email to confirm this payment.</h2>
              <a href="?mod=user&act=trangchu" style="text-align: center;">Continue Shopping</a>
            </div>
