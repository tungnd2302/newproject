...
?>
	<div class="right_col" role="main" style="min-height: 1704px;">
            ...
            <form method="post" action="?mod=sanpham&act=themact" class="form-horizontal" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="Namsanxuat" class="form-control" style="width: 60%">
                        </div>
                    </div>
                    <div class="form-group">
                        <label style="font-size: 18px;" class="col-md-2 col-md-offset-3">Tồn kho</label>
                        <div class="col-md-6">
                            <input type="text" name="Tonkho" class="form-control" style="width: 60%">
                        </div>
                    </div>
                    <div class="form-group">
                        <label style="font-size: 18px;" class="col-md-2 col-md-offset-3">Bộ xử lý</label>
                        <div class="col-md-6">
                            <input type="text" name="Boxuly" class="form-control" style="width: 60%">
                        </div>
                    </div>
                    <div class="form-group">
                        <label style="font-size: 18px;" class="col-md-2 col-md-offset-3">Ram</label>
                        <div class="col-md-6">
                            <input type="text" name="Ram" class="form-control" style="width: 60%">
                        </div>
                    </div>
                     <div class="form-group">
                        <label style="font-size: 18px;" class="col-md-2 col-md-offset-3">Ổ cứng</label>
                        <div class="col-md-6">
                            <input type="text" name="Ocung" class="form-control" style="width: 60%">
                        </div>
                    </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="Giaban" class="form-control" style="width: 60%" >
                        </div>
                    </div>
                     <div class="form-group">
                        <label style="font-size: 18px;" class="col-md-2 col-md-offset-3">Màn hình</label>
                        <div class="col-md-6">
                            <input type="text" name="Manhinh" class="form-control" style="width: 60%">
                        </div>
                    </div>
                    <div class="form-group">
                        <label style="font-size: 18px;" class="col-md-2 col-md-offset-3">Giới thiệu</label>
                        <div class="col-md-6">
                            <input type="text" name="Gioithieu" class="form-control" style="width: 60%">
                        </div>
                    </div>
                    <div class="form-group">
