...
?>
	<div class="right_col" role="main" style="min-height: 1704px;">
    		<h2 class="text-center">Sửa Mặt Hàng</h2>  
            <form method="post" action="?mod=loaisanpham&act=suaact" class="form-horizontal" enctype="multipart/form-data" >
                    <div class="form-group">
                        <label style="font-size: 18px;" class="col-md-2 col-md-offset-3">Mã loại sản phẩm</label>
                        <div class="col-md-6">
                            <input type="text" name="Ma" readonly="readonly" class="form-control" style="width: 60%" value="<?php echo $loaisanpham['Ma'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label style="font-size: 18px;" class="col-md-2 col-md-offset-3">Tên loại sản phẩm</label>
                        <div class="col-md-6">
                            <input type="text" name="Ten" class="form-control" style="width: 60%" value="<?php echo $loaisanpham['Ten'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select style="width: 60%" name="Baohanh" class="form-control">
                                <option><?php echo $loaisanpham['Baohanh'] ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <button type="submit" class="btn btn-primary">Cập nhật Loại Mặt Hàng</button>
